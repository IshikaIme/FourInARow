...
iDrawSet()
{
    ...
    iSetColor(0,0,0);
    iText(860,440,"UNDER THE SKY",GLUT_BITMAP_TIMES_ROMAN_24);
    iText(860,360," COME SWIM WITH ME",GLUT_BITMAP_TIMES_ROMAN_24);
    iText(860,280,"       CLEAR THE BLOCK",GLUT_BITMAP_TIMES_ROMAN_24);
    iText(860,200,"       WHITE LIKE SNOW",GLUT_BITMAP_TIMES_ROMAN_24);
    iText(860,120,"     MEET OLD FRIENDS",GLUT_BITMAP_TIMES_ROMAN_24);
...
iDrawRules()
{
    ...
    iText(400,rulesY-610,"board to play and that's whay have to use there vision in order to win.",GLUT_BITMAP_9_BY_15);
...
//    iText(70,65,"EXIT",GLUT_BITMAP_TIMES_ROMAN_24);
        ...
        iSetColor(255,255,255);
        iText(70,45, "Press ESC to back to MAINMENU",GLUT_BITMAP_TIMES_ROMAN_24);
